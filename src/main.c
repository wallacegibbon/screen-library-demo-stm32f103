...
#include "ssd1306.h"
//#include "st7735_stm32f10x_spi.h"
//#include "st7735.h"
#include "painter.h"
#include "common.h"
#include "color.h"
...
void initialize_screen_1(
	...
	struct SSD1306_ScreenAdaptorSTM32F10xI2C *adaptor1
) {
	printf("initializing SSD1306...\r\n");

	SSD1306_ScreenAdaptorSTM32F10xI2C_initialize(
		adaptor1, 0x3C
	);
...
void initialize_screen_2(
	...
	struct ST7735_ScreenAdaptorSTM32F10xSPI *adaptor2
) {
	printf("initializing ST7735...\r\n");

	ST7735_ScreenAdaptorSTM32F10xSPI_initialize(
		adaptor2, ...
	);
